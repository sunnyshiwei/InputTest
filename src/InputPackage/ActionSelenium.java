...
public class ActionSelenium {
	...
	/*
	 * 上传文件 
	 * 方法一：用js手动改动js代码，使其【更换头像】直接显示
	 * 且使用sendkeys方法时，标签必须是input*/
	...
	/*上传文件
	 * 方法三：由于系统文件脚本无法识别，推荐使用AutoIT工具实现文件上传*/
	...
	/*元素进阶 Actions action=new Actions(dirver)
	 * 鼠标左击：action.click().perform()
	 * 鼠标右击：action.contextClick().perform()
	 * 鼠标双击：action.doubleClick().perform()
